...
def create_iam_policy_file(name, sid, effect, service, action, resource=None):
...
def create_policy(new_policy):
    ...
    try:
        ...
        arn = get_iam_policy_arn(new_policy=new_policy)
...
def delete_policy_file(new_policy):
    ...
    print(f"policy succesfully locally deleted: {new_policy}")


# fix this so it skips the addition of the service if the user enters * for serivce
